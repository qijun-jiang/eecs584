...
6. You can check the result file quickly by use
   * Command line: cat 

7. To change the algorithm for SELECT query, you can uncomment one algorithm in 
